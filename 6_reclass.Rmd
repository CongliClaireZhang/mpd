...
sfusd %>% 
  ...
  labs(title = "Trend of SFUSD RFEP rate by focal ethinicity group in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
...
sfusd %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of SFUSD RFEP rate of dually identified ELs in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of SFUSD RFEP rate by school level in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Dark2") + 
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of elementary school RFEP rate by focal ethnicity group in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Dark2") + 
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of middle school RFEP rate by focal ethnicity group in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Dark2") + 
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of high school RFEP rate by focal ethnicity group in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Dark2") + 
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of elementary school RFEP rate of dually identified ELs in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Set1") + 
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of middle school RFEP rate of dually identified ELs in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Set1") + 
...
level %>% 
  ...
  geom_line(aes(group = group), size = 0.8) +
  theme_bw(base_size = 14) +
  labs(title = "Trend of high school RFEP rate of dually identified ELs in nine years",
       x = "School Year",
       y = "RFEP Rate",
       color = "") +
  scale_color_brewer(palette = "Set1") + 
