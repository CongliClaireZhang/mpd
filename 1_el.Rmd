---
title: "Student Population and Multilingual Learners"
---
...
As of `r Sys.Date()`^[Data source: SFUSD Synergy data system], there are a total of `r nrow(mlml)` ELs actively enrolled in SFUSD, making up to `r percentage(nrow(mlml)/nrow(ml))` of the student population^[Student population: the total of students in SFUSD schools excluding Charter schools]. Below is a breakdown of the proportions of four major English Language Acquisition Status, or ELAS: EL, RFEP, IFEP, and EO.
...
The following five plots provide a closer look at the up-to-date student enrollment by ELAS at each school. Each plot shows schools in each of the five cohorts: high schools, middle schools, K-8 schools, elementary schools, and early elementary schools. 
...
EL population is diverse in terms of where they are on the spectrum of English language proficiency. EL typology is designed to identify different subgroups of ELs so that we can provide research-based multilingual programs and interventions that meet their unique learning needs. 

Please refer to [this slide](https://docs.google.com/presentation/d/12GjkZb5EjsPEqNjqSC97w08JtjseHqMAqfdzIRYsx1E/edit#slide=id.g288282fe4fd_0_4) to understand more about how SFUSD identify different typologies of ELs. Here is a brief glossary of EL Typology categories used in this website:
...
Similar to the previous section, below five plots provide a closer look at the up-to-date student enrollment by EL Typology at each school. Hove over a specific proportion of the colored bar of a specific school to find out the number of students in detail. 

Note that for the three cohorts: high schools, middle schools, and K-8, the bars are ordered by the proportion of LETLs from the highest to the lowest, whereas for the other two cohorts: elementary and early elementary schools, the bars are ordered by the proportion of Newcomers.
