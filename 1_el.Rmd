...
pacman::p_load(tidyverse, janitor, readxl, writexl, here, plotly, cowplot)
...
Below is a breakdown of the proportions of the five EL Typology groups at SFUSD, as of `r Sys.Date()`:
...
For the following two cohorts, elementary and early elementary schools, the bars are ordered by the first proportion - the proportion of Newcomers from the highest to the lowest:
